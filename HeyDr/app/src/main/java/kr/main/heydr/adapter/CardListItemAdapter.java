...
public class CardListItemAdapter extends ECCardContentListItemAdapter<String> {
    ...
    public CardListItemAdapter(@NonNull Context context, int resource, @NonNull List<String> objects, PharmacyActivity activity) {
    ...
    private static PharmacyActivity activity;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.itemText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gotoShowMoreRiple = new Intent(context, PharmacyDetailActivity.class);
